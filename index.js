...
},
{
    ...
    rating : 4.3,
    price: 40,
    img: 'images/pizza/pizzalogo.png',
    quantity: 1
}
]
...
const rightMenuData= [...new Map(foodItem.map(item=> [item['category'],item])).values()];
